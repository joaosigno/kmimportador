...
/*Confere se o campo compareceu tem algum outro valor que n�o seja S ou N*/
if (!$kmi->addCheck(KM_IMPORTADOR_CONSISTIR_REGEX, 'COMPARECEU', '[SN]')) {
	echo '<b>Erro:</b> Valor inv�lido para o campo "COMPARECEU", o campo s� aceita "S" ou "N"<br>';
